...
import 'package:flutter_ayolapor/dashboard.dart';
import 'package:flutter_ayolapor/signup.dart';
          ...
          children: <Widget>[
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text("Log in", style: TextStyle(fontFamily: "Regular", fontSize: 28.0, fontWeight: FontWeight.w700),),
                  SizedBox(height: 12.0,),
                  SizedBox(width: 52.0, height: 4.0,
                  child: Container(
                  ...
                  SizedBox(height: 12.0,),
                  Text("Please Login to your account to continue using Utawi Iku", style: TextStyle(fontFamily: "Regular", fontSize: 16.0, fontWeight: FontWeight.w600),)
                ],
              ),
            ),
            Padding(
                  ...
                  children: <Widget>[
                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Login", style: TextStyle( fontSize: 16.0, fontFamily: "Regular", fontWeight: FontWeight.w600, color: Colors.white ),),
                        ),
                      ),
                    )
                  ],
